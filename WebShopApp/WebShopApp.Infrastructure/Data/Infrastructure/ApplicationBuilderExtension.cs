...
namespace WebShopApp.Infrastructure.Data.Infrastructure
{
    public static class ApplicationBuilderExtension
    {
        public static async Task<IApplicationBuilder> PrepareDatabase(this IApplicationBuilder app)
        {
            ...
            var dataCatecory = serviceScope.ServiceProvider.GetRequiredService<ApplicationDbContext>();
            SeedCategories(dataCatecory);
            var dataBrand = serviceScope.ServiceProvider.GetRequiredService<ApplicationDbContext>();
            SeedBrands(dataCatecory);
            return app;
        ...
        private static async Task SeedAdministrator(IServiceProvider serviceProvider)
        {
            ...
            if (await userManager.FindByNameAsync("admin") == null)
            {
                ...
                if (result.Succeeded)
                {
                    userManager.AddToRoleAsync(user, "Adminitrator").Wait();
                }
